...
function main() {
  ...
  local -r arg_version_presto=$(mdata-get 'version_presto')
  local -r arg_version_presto_manta=$(mdata-get 'version_presto_manta')
  local -r arg_mode_presto=$(mdata-get 'mode_presto')
  local -r arg_address_presto_coordinator=$(mdata-get 'address_presto_coordinator')
  local -r arg_manta_url=$(mdata-get 'manta_url')
  local -r arg_manta_user=$(mdata-get 'manta_user')
  local -r arg_manta_key_id=$(mdata-get 'manta_key_id')
  local -r arg_manta_key=$(mdata-get 'manta_key')
  check_arguments \
